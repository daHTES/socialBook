                            ...
                            <div class="nf-1-left">
                                ...
                                <div class="nf-pro-name-time">
                                    <div class="nf-pro-name">
                                        <a href="<?php echo BASE_URL.$post->userLink; ?>" class="nf-prof-name">
                            ...
                            <div class="nf-2-img" data-postid="<?php echo $post->post_id; ?>" data-userid="<?php echo $user_id;?>">
                                <?php
                                    ...
                                    for($i = 0; $i < count($imgJson); $i++){
                                        ...
                                        data-postimgid="'.$post->id.'" 
                                        style="max-height:400px; overflow: hidden;">
                                        <img src="'.BASE_URL.$imgJson[''.$count++.'']->imageName.'" 
                                        data-userid="'.$user_id.'" 
                                                ...
                                                <div class="com-text-react-wrap">
                                                    <div class="com-text-option-wrap align-middle">
                                                        <div class="com-react-placeholder-wrap align-middle">
                                                            ...
                                                            <span class="co-text"
                                                                  ...
                                                                  data-profilepic="<?php echo $userdata->profilePic; ?>"><?php echo $comment->comment; ?></span>
                                                            </div>
                                                            <div class="com-nf-3-wrap">
                                                                ...
                                                                if($com_main_react_count->maxreact == '0'){
                                                                    ...
                                                                    <div class="com-nf-3 align-middle">
                                                                        ...
                                                                        <div class="nf-3-react-username">
                                                                            <?php
                                                                            if($com_main_react_count == '0'){}else{
                                                        ...
                                                        if($user_id == $comment->commentBy){
                                                            ...
                                                            <div class="com-dot-option-wrap">
                                                                <div class="com-dot"
                                                                     style="color:gray; margin-left: 5px; cursor: pointer; font-weight: 600;"
                                                                     data-postid="<?php $comment->commentOn;?>"
                                                                    data-userid="<?php echo $user_id;?>"
                                                                    data-commentid="<?php echo $comment->commentID;?>">...
                                                                </div>
                                                    ...
                                                    <div class="com-react">
                                                        ...
                                                        <div class="com-reply-action"
                                                             ...
                                                             data-userid="<?php echo $user_id;?>"
                                                             data-commentid="<?php echo $comment->commentID;?>"
                                                              data-profilepic="<?php echo $userdata->profilePic;?>">Reply
                                                        </div>
                                                        <div class="com-time"><?php $this->timeAgo($comment->commentAt);?></div>
                                                    </div>
                                                </div>
                                             </div>
                                        </div>
